...
public class BackGround_startstate extends GraphicObject{
    public BackGround_startstate() {
        super(AppManager.getInstance().getBitmap(R.drawable.bg_start_background));
    }
